...
public static @NotNull BigDecimal findTicker(String symbol) throws KeyManagementException, InvalidKeyException, MalformedURLException, NoSuchAlgorithmException, IOException {
  ...
  public static void buyLimitOrder(String symbol, BigDecimal limitPrice, boolean reduceOnly) throws KeyManagementException, InvalidKeyException, MalformedURLException, NoSuchAlgorithmException, IOException {
    // send limit order
    String side = "buy";
    String orderType = "post";
    BigDecimal size = BigDecimal.valueOf(1000);
...
//    System.out.println("Levaerage sell  (limit):\n" + leverageResult);
  ...
  public static void sellLimitOrder(String symbol, BigDecimal limitPrice, boolean reduceOnly) throws KeyManagementException, InvalidKeyException, MalformedURLException, NoSuchAlgorithmException, IOException {
    // send limit order
    String side = "sell";
    String orderType = "post";
    BigDecimal size = BigDecimal.valueOf(1000);
